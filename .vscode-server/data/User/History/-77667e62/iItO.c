...
char* tab_complete(const char* text, int state);
...
char* tab_complete(const char* text, int state) {
    ...
    if (path && *path) {
        ...
        int path_len = colon ? colon - path : strlen(path);
...
int main(int argc, char *argv[]) {
    ...
    rl_completion_entry_function = tab_complete;
